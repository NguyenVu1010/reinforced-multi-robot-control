...
class RobotState:
    ...
    def __init__(self):
        ...
        self.is_tilted = False          # Biến để theo dõi trạng thái nghiêng của robot
    def update_kinematics(self, pose_msg, twist_msg,is_tilted_flag):
